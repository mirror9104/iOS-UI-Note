...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // 在使用UICollectionViewController时 在创建初始时就需要给一个 布局对象
    LineLayout *layout = [[LineLayout alloc] init];
    
    RootViewController *rootVC = [[[[RootViewController alloc] init] initWithCollectionViewLayout:layout ] autorelease];
