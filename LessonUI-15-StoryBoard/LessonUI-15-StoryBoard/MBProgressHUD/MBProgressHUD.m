...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    NSDictionary *attribute2 = @{NSFontAttributeName: label.font};
    CGSize labelSize = [label.text sizeWithAttributes:attribute2];
    ...
    // 之前的sizeWithFont过时,重写了boundingRectWithSize方法,如果有错请注开这个使用
//	CGSize detailsLabelSize = [detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:(NSStringDrawingTruncatesLastVisibleLine) attributes:attribute context:nil].size;
