...
#pragma mark - 将中文字转换成无音标拼音
    /** 中文转英文 提取中文首字母 */
    NSMutableString *name = [NSMutableString stringWithFormat:@"胡春源"];
    NSLog(@"%@",name);
...
//    CFStringTransform((CFMutableStringRef)name, NULL, kCFStringTransformMandarinLatin, YES);
    NSLog(@"%@",name);
    return YES;
}
